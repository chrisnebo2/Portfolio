...
function NavBar() {
  ...
  return (
    <div className="w-full bg-black text-white px-4 md:px-6 h-20 flex items-center justify justify-between fixed top-0">
        <div>
        ...
        <ul className="hidden md:flex">
            {
                myLinks.map(({link, id}) => (
                    <li key={id} className="capitalize font-medium px-4 text-gray-400 hover:scale-105 duration-200 ease-out cursor-pointer hover:text-gray-200">{link}</li>
                ))
            }
        </ul>
