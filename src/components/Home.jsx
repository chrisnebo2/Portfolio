...
function Home() {   
  ...
  return (
    ...
    >
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-5 md:gap-16 items-center justify-center px-4 md:px-6 gap-y-8">
            <div className="md:col-span-3 flex flex-col justify-center h-full gap-1 md:gap-3">
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-relaxed">I'm Frontend Web Developer</h2>
